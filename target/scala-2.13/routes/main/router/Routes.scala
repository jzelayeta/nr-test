...
class Routes(
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:12
    Assets_1: controllers.Assets
  ) = this(errorHandler, HomeController_2, AsyncController_0, Assets_1, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_2, AsyncController_0, Assets_1, prefix)
  }
 ...
 An example controller showing how to write asynchronous code""",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_AsyncController_message1_route(params@_) =>
      call { 
        controllers_AsyncController_message1_invoker.call(AsyncController_0.message)
      }
